	...
	<div class="container-fluid" id="main">
		<div class="card">
			...
			<div class="card-body bg-light border-success mb-3 col-lg-12"
				style="color: navy;">
				<form:form action="receipt" method="POST" modelAttribute="receipt"
					name="receiptform">
					<form:hidden path="custId" id="cid" />
					<form:hidden path="statusPrint" id="printReceipt"/>
			...
			--%>
					...
					<div class="form-row text-center">
						<div class="form-group col-md-2 col-lg-8">
							<a href="<%= request.getContextPath()%>/payment/receipt"
								class="btn btn-info" role="button"
								style="width: 200px; font-size: 20px"><i
								class="fa fa-refresh"
								style='font-size: 20px; padding: 0 1em 0 0'></i>Refresh
							</a>
							<button type="submit" class="btn btn-success"	style="width: 200px; 
							    font-size: 20px" onclick="myFunction()" ><i class="fa fa-inr"
								style='font-size: 20px; padding: 0 1em 0 0'></i>Confirm	Receipt
							</button>
							<button type="submit" class="btn btn-danger" id="printMe" style="width:200px;
							    font-size:20px" onclick="printPDF();" >
							<i class="fa fa-print" style='font-size: 20px;padding: 0 1em 0 0'></i>Print Receipt
							</button>
						</div>
					</div>
			</form:form>
...
function printPDF(){
	...
	document.getElementById("printMe").style.display="none";
	//alert("receipt val"+receiptid);
	var url = '${pageContext.request.contextPath}/payment/showPDF/'+receiptid;
	var win = window.open(url, '_blank');
  //	win.focus();	
}
function myFunction() {
	  var txt;
	  if (confirm("Do you need to Print Receipt !!!") ==true) {
	    txt = "Yes";
	   } else {
	    txt = "No";
	  }
	  $("#printReceipt").val(txt);
	}
</script>
</html>