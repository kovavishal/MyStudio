					...
					<form>
						<div class="form-row">
							<div class="form-group col-md-6 col-lg-3">
								<form:input path="name" class="form-control"
									placeholder="Product Name" id="metaname" required="true" />
							</div>
							<div class="form-group col-md-6 col-lg-3">
						...
						<div class="table-responsive col-lg-8" style="padding-left: 0px;">
							<table id="producttable"
								...
								<thead>
									<tr>
										<th class="col-sm-1 col-lg-1" data-field="id">Id</th>
										<th class="col-sm-3 col-lg-10" data-field="name">Name</th>
										<th class="col-sm-1 col-lg-1" data-field="checkDelete">Action</th>
									</tr>
								</thead>
							</table>
						</div>
...
$(document).ready(function(){
	...
	tableClient = $('#producttable').DataTable({
		...
		"ajax": {
			"url": "${pageContext.request.contextPath}/metadata/producttypes",
			"type": "POST",
			"success" :  function(data){
				$.each(data, function(index, obj){
					...
					tableClient.row.add([
						...
						obj.id,
						obj.name,
						"<input type='button' value='Update' id='id_"+obj.id+"' onclick='deleteProduct("+obj.id+");'>",
					]).draw();
...
function deleteProduct(productTypeId){
	var metaname = $('#metaname').val();
	if(metaname!= ''){
		$.ajax({
			type: "PUT",
			url: "${pageContext.request.contextPath}/metadata/delete/" + productTypeId+"/"+metaname,
			timeout : 100000,
			success: function(data){
