		...
		<div class="card">
			<div class="card-header text-center"
				...
				<jsp:include page="logout.jsp">
					<jsp:param name="page" value="Outstanding Report" />
				</jsp:include>
			</div>
     ...
     <div class="col-md-4 col-lg-3">
	  ...
	  --%>
					...
					<div class="col-lg-9 text-right" style="padding-top: 0px;">
						<P align="right">
							<a
								href="<%= request.getContextPath()%>/report/customeroutstanding"
						...
						<table id="reporttable"
							...
							<thead>
								<tr>
									...
									<!-- <th class="col-sm-3"  style="width:10%;position:relative;text-align:center;" data-field="referenceType">Town/City</th> -->
									<th class="col-sm-3"
										style="width: 10%; position: relative; text-align: center;"
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    ...
    var reqData={'report': 'customeroutstanding'};
	document.title = 'Customer Outstanding Report as on '+today; 	
