...
<title>Customer Outstanding Summary Report</title>
		...
		<div class="card">
			<div class="card-header text-center"
				...
				<jsp:include page="logout.jsp">
					<jsp:param name="page" value="Customer Outstanding Summary Report" />
				</jsp:include>
			</div>
...
function report(){
	...
	var tableClient = $('#reporttable').DataTable({
		...
		"searching":true,
		 "ordering": false,
		"ajax": {
			"url": "${pageContext.request.contextPath}/report/cosdetail",
			"type": "POST",
			"data" : reqData,
