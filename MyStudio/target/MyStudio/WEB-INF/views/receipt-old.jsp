					...
					<div id="table" class="table-editable">
							...
							<div class="form-group col-md-2 col-lg-11">
								<c:if test="${not empty orderIds }">
									<table
										...
										<c:forEach items="${receipt.receiptPayments}" var="vPayment"
											varStatus="loop">
											<tr>
												<%-- <td>
						<form:select path="receiptPayments[${loop.index}].refTypeId" class="form-control" id="vPayment_${loop.index}" required="true">
							...
							<option value="${vType.id}">${vType.name}</option>
												...
												<td><form:select
														path="receiptPayments[${loop.index}].refNo"
														class="form-control" id="reference_${loop.index}"
														required="true" onchange="setOrderAmount(${loop.index});">
												...
												<td class="pt-3-half"><form:input
														path="receiptPayments[${loop.index}].netAmount"
														class="form-control" id="net_${loop.index}"
														readonly="true" /></td>
												<td class="pt-3-half"><form:input
														path="receiptPayments[${loop.index}].paidAmount"
												...
												<td class="pt-3-half"><input type="text"
													class="form-control" id="payable_${loop.index}"
