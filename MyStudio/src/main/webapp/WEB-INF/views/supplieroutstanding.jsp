...
<link type="text/css" href="/css/dataTables.checkboxes.css"
	rel="stylesheet" />
<!-- <title>Supplier's Outstanding Report</title> -->
</head>
<body>
		...
		<div class="card">
			<div class="card-header text-center"
				...
				<jsp:include page="logout.jsp">
					<jsp:param name="page" value="Supplier's Outstanding" />
				</jsp:include>
			</div>
			<form:form method="POST" action="supplieroutstanding"
     ...
     <div class="col-md-4 col-lg-3">
	  ...
	  --%>
					...
					<div class="col-lg-9 text-right" style="padding-top: 0px;">
						<P align="right">
							<a
								href="<%= request.getContextPath()%>/report/supplieroutstanding"
						...
						<table id="reporttable"
							...
							<thead>
								<tr>
									...
									<th data-field="creditAmount" hidden="true">Supplier.No</th>
									<th style="width: 2%; position: relative; text-align: center;"
										data-field="description">Sl.No.</th>
									<th style="width: 20%; position: relative; text-align: center;"
										data-field="description">Supplier Name</th>
									<th style="width: 25%; position: relative; text-align: center;"
										data-field="referenceType">Address 1</th>
									<th style="width: 15%; position: relative; text-align: center;"
										data-field="referenceType">Address 2</th>
									<th style="width: 10%; position: relative; text-align: center;"
										data-field="debitAmount">Mobile No</th>
									<th style="width: 10%; position: relative; text-align: center;"
										data-field="creditAmount">Due Amount</th>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
	    ...
	    var reqData={'report': 'supplieroutstanding'};
		document.title = 'Supplier Outstanding Report as on '+today; 	
		var tableClient = $('#reporttable').DataTable({
			"destroy": true,
			"searching":true,
			"ajax": {
				"url": "${pageContext.request.contextPath}/report/supplier_outstanding_detail",
				"type": "POST",
				"data" : reqData,
