...
<link rel="stylesheet" type="text/css" href="/css/dataTables.bootstrap.css" rel="stylesheet" /> 
<script src="<%=request.getContextPath()%>/js/jquery-3.3.1.js"></script>
<script src="<%=request.getContextPath()%>/js/dataTable.checkboxes.js"></script>
<script src="<%=request.getContextPath()%>/js/dataTable.checkboxes.min.js"></script>
	...
	<div class="container-fluid" id="main">
		<div class="card">
			<div class="card-header text-center"
				...
				<jsp:include page="logout.jsp">
					<jsp:param name="page" value="Customer's Address Report" />
				</jsp:include>
			</div>
     ...
     <div class="col-md-4 col-lg-3">
	  ...
	  --%>
					...
					<div class="col-lg-11 text-right" style="padding-top: 0px;">
						<P align="right">
							<%-- 	  <a href="<%= request.getContextPath()%>/report/customeraddress" class="btn btn-info" role="button">Refresh</a></P>
 --%>
							<a href="<%= request.getContextPath()%>/report/customeraddress"
						...
						<table id="reporttable"
							...
							<thead>
								<tr>
									...
									<th class="col-sm-1" data-field="creditAmount">Cust.No</th>
									<th class="col-sm-3" data-field="description">Customer	Name</th>
									<th class="col-sm-3" data-field="referenceType">Address-1</th>
									<th class="col-sm-3" data-field="referenceType">Address-2</th>
									<th class="col-sm-1" data-field="debitAmount">MobileNo</th>
									<th class="col-sm-1" data-field="description">Area</th>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    ...
    var reqData={'report': 'customeraddress'};
	document.title = 'Customer Address List'; 	
	var tableClient = $('#reporttable').DataTable({
		"destroy": true,
		"searching":true,
		"ajax": {
			"url": "${pageContext.request.contextPath}/report/cust_address_detail",
			"type": "POST",
			"data" : reqData,
