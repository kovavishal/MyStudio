		...
		<div class="card">
			<div class="card-header text-center"
				...
				<jsp:include page="logout.jsp">
					<jsp:param name="page" value="Cancelled Order Report" />
				</jsp:include>
			</div>
			<form:form method="POST" action="ledger" modelAttribute="report"
				...
				<div class="card-body bg-light border-success mb-3 col-lg-12"
					...
					<div class="col-lg-9 text-right" style="padding-top: 10px;">
						<a href="<%= request.getContextPath()%>/report/cancelorderreport"
					...
					<table id="reporttable"
						...
						<thead>
							<tr>
								...
								<th class="col-sm-3"
									style="width: 10%; position: relative; text-align: center;"
									data-field="trxnType">Order Amt.</th>
								<th class="col-sm-3"
									style="width: 15%; position: relative; text-align: center;"
									data-field="trxnType">Advance</th>
								<th class="col-sm-3"
									style="width: 15%; position: relative; text-align: center;"
									data-field="trxnType">Balance</th>
								<th class="col-sm-3"
									style="width: 10%; position: relative; text-align: center;"
									data-field="trxnType">Cancelled Date</th>
								<!-- <th class="col-sm-3" style="width:15%;position:relative;text-align:center;"data-field="debitAmount">Amount(Dr)</th>
					<th class="col-sm-1" style="width:15%;position:relative;text-align:center;"data-field="creditAmount">Amount(Cr)</th>
...
function report(){
	...
	var tableClient = $('#reporttable').DataTable({
		...
		"searching":true,
		 "ordering": false,
		"ajax": {
			"url": "${pageContext.request.contextPath}/report/cancel_order_report",
			"type": "POST",
			"data" : reqData,
